...
export const projects=rawProjects.map(project=>{
  ...
  if(research)return {...project,rating:research.rating,ratingBasis:research.score==null?`建商研究已覆核（${research.reviewed}）：${research.caveat}`:`建商研究 ${research.score} 分（基礎 ${research.baseScore} − 風險調整 ${research.riskAdjustment}；${research.reviewed} 覆核）`};
