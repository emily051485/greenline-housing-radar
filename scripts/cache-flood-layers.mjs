...
// Covers every currently mapped project plus the surrounding Green Line corridor.
...
async function fetchScenario(name,layers,token){
  ...
  const response=await fetch(endpoint,{headers:{Origin:'https://emily051485.github.io'}});
